...
CHAT_MODELS = [
    ...
    ('Llama-4-Maverick-17B-128E-Instruct-FP8',
     True, ['text', 'image'], ['text']),
    ('Llama-4-Scout-17B-16E-Instruct',
     True, ['text', 'image'], ['text']),
    ('MAI-DS-R1', True, ['text'], ['text']),
    ...
    ('Phi-4-mini-reasoning', True, ['text'], ['text']),
    ('Phi-4-multimodal-instruct', True,
     ['audio', 'image', 'text'], ['text']),
    ('Phi-4-reasoning', True, ['text'], ['text']),
    ('cohere-command-a', True, ['text'], ['text']),
    ('gpt-4.1', True, ['text', 'image'], ['text']),
